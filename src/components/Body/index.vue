<template>
  <section class="flex flex-col justify-center items-center w-full h-full">
    ...
    <div class="flex flex-col  h-1/6 w-1/6">
      <div class="flex justify-center items-center w-full gap-5 h-5/6">
        <div>
          <h1 class="font-bold text-main-blue text-2xl ">Experiência</h1>
        </div>        
      </div>
    </div>
    <div class="flex justify-center items-center gap-10 px-5 w-full h-full bg-background-experience bg-top bg-origin-content bg-no-repeat">
